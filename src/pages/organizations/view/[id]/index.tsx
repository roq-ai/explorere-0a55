...
import { getSalesManagers, deleteSalesManagerById, createSalesManager } from 'apiSdk/sales-managers';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6}>
              <UserPageTable
                createHandler={createSalesManager}
                deleteHandler={deleteSalesManagerById}
                fetcher={getSalesManagers}
